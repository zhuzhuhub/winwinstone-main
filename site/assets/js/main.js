...
const translations = {
  en: {
    ...
    text: [
      ...
      [".hero .eyebrow", "Factory Direct from Yunfu, China"],
      ["#hero-title", "Custom Natural Stone Products Made for Brands, Designers, and Projects"],
      [".hero-copy", "OEM/ODM marble sinks, travertine dining tables, stone vanities, bathtubs, fireplace surrounds, and bespoke furniture produced with factory control and global delivery support."],
      [".hero-trust span:nth-child(1)", "15+ years of factory experience"],
      [".hero-trust span:nth-child(2)", "Custom sizes, finishes, and packaging"],
      [".hero-trust span:nth-child(3)", "OEM/ODM support for repeat orders"],
      [".hero-trust span:nth-child(4)", "Export-ready delivery for global buyers"],
      ...
      [".intro .eyebrow", "Factory-Backed Production"],
      ["#intro-title", "Custom natural stone production built for real orders."],
      [".intro-right p:nth-child(1)", "Based in Yunfu, Guangdong, one of the world's best-known stone industry centers, Win-Win Stone manufactures custom natural stone products for residential, commercial, and hospitality use."],
      [".intro-right p:nth-child(2)", "We work with marble, travertine, quartzite, onyx, and other natural materials to create sinks, vanities, bathtubs, tables, fireplace surrounds, and bespoke project pieces with stable quality and practical export support."],
      [".intro-points span:nth-child(1)", "Custom size and design"],
      [".intro-points span:nth-child(2)", "Low MOQ for selected product lines"],
      [".intro-points span:nth-child(3)", "Factory-direct pricing"],
      [".intro-points span:nth-child(4)", "Global shipping support"],
      [".products .eyebrow", "Our Products"],
      ["#products-title", "Custom stone product categories built for OEM/ODM production."],
      [".products .section-heading > p:last-child", "Explore sinks, tables, vanities, bathtubs, and fireplace pieces that can be adjusted by stone selection, dimensions, finish, edge detail, and packing requirement."],
      ...
      [".video-grid p:last-child", "From drawing confirmation and material sourcing to fabrication, inspection, export packing, and shipment coordination, we keep the production path clear for buyers who need practical execution."],
      [".service .eyebrow", "OEM/ODM Service"],
      ["#service-title", "A clear OEM/ODM process from drawing to delivery."],
      [".why .eyebrow", "Why Win-Win Stone"],
      ["#why-title", "Why global buyers choose Win-Win Stone."],
      [".why-copy p:nth-of-type(2)", "We focus on the production details that help custom stone orders move forward: material clarity, drawing confirmation, practical communication, stable quality control, and export-ready packing."],
      [".why-copy p:nth-of-type(3)", "Whether the order is a sample, a repeatable product line, or a coordinated project piece, our role is to make custom stone production easier to specify and easier to deliver."],
      [".contact .eyebrow", "Contact"],
      ["#contact-title", "Share your drawing, target size, stone preference, or product idea."],
      [".contact-grid > div > p:nth-of-type(2)", "Send your requirements and we will help confirm the material direction, estimate the production path, and prepare the next step for your OEM/ODM inquiry."],
      ...
      [".site-footer p", "Factory-backed natural stone manufacturing with OEM/ODM support, custom production, and export-ready delivery."],
    ...
    proof: [
      ["Factory-direct pricing", "Work closer to production without unnecessary trading layers."],
      ["Flexible OEM/ODM support", "Suitable for custom development, small-batch testing, and repeat orders."],
      ["Natural stone expertise", "Material selection and fabrication are guided by real stone behavior, not surface appearance alone."],
      ["Export experience", "Inspection, protection, packing, and delivery details are handled with global shipment needs in mind."]
    ],
    placeholders: {
