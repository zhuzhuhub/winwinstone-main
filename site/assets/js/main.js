...
const translations = {
  ...
  zh: {
    ...
    text: [
      ...
      [".category-card:nth-child(1) h4", "石材台盆"],
      [".category-card:nth-child(1) p", "提供大理石、洞石等天然石材的立柱盆与台上盆形式。"],
      [".category-card:nth-child(2) h4", "石材餐桌"],
      [".category-card:nth-child(2) p", "适合家居品牌和定制项目的餐桌、茶几与玄关台单品。"],
      [".category-card:nth-child(3) h4", "项目定制家具"],
      [".category-card:nth-child(3) p", "支持酒店、别墅和设计师项目的石材家具定制生产。"],
      [".category-card:nth-child(4) h4", "石材浴缸"],
      [".category-card:nth-child(4) p", "适用于高端浴室和SPA项目的天然石材浴缸定制。"],
      [".category-card:nth-child(5) h4", "石材壁炉"],
      [".category-card:nth-child(5) p", "适用于住宅、精品酒店和设计师项目的定制壁炉石材产品。"],
